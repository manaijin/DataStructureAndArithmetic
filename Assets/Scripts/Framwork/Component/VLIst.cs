...
{
    public class VLIst: Framwork.UIBase.Component
    {
        /// <summary>
        /// 列表函数委托
        /// </summary>
        ...
        /// <returns></returns>
        public delegate Framwork.UIBase.Component SetItemFunction(int index);
        /// <summary>
        /// 创建单个item
        /// </summary>
        ...
        public int DataCount
        {
            ...
            {
                dataCount = value;
                Framwork.UIBase.Component.removeAllChilds(content);
                if (ItemFunction == null)
                    return;
                for (int i = 0; i < dataCount; i++)
                {
                    GameObject item = ItemFunction(i).component;
                    AddChild(item);
                }
            }
        }
        ...
        public VLIst()
        {
            component = ResourcesManager.LoadPrefabByPath("Prefab/Custom/V_list");
